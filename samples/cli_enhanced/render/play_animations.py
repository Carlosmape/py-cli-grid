...
while (True):
    ...
    print(" ======="*3)
    print("|"+pjrendered[0]+"|"+pjrendered_sword[0] +
          "|"+pjrendered_staff[0]+"|")
    print("|"+pjrendered[1]+"|"+pjrendered_sword[1] +
          "|"+pjrendered_staff[1]+"|")
    print("|"+pjrendered[2]+"|"+pjrendered_sword[2] +
          "|"+pjrendered_staff[2]+"|")
    print(" ======="*3)
    ...
    print(" ======="*3)
    print("|"+grass_render1.render()
          [0]+"|"+grass_render2.render()[0]+"|"+grass_render3.render()[0]+"|")
    print("|"+grass_render1.render()
          [1]+"|"+grass_render2.render()[1]+"|"+grass_render3.render()[1]+"|")
    print("|"+grass_render1.render()
          [2]+"|"+grass_render2.render()[2]+"|"+grass_render3.render()[2]+"|")
    print(" ======="*3)
