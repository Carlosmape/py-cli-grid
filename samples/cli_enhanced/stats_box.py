...
class PjStatsBox(CommandLineBox):
    ...
    def _render_equipment(self, pj: PlayerCharacter):
        ...
        pj_str += "\n"+style.CITALIC+strArms +style.CEND+style.CVIOLET+"/ | | \\"+style.CEND+strHands
    ...
    def render(self, pj: PlayerCharacter):
        ...
        quests_col_str = self._render_quests(pj)
        return self.render_cols([stats_col_str, equipment_col_str, quests_col_str])
